...
\author{Olamilekan Wahab% <-this % stops a space
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
Developing natural language processing tools has become significantly 



Developing natural language processing
tools for low-resource languages often requires
